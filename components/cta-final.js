    ...
    return `
      <section class="cta-faixa" id="contacto" aria-labelledby="cta-titulo">
        <div class="container cta-faixa__inner">
          ...
          <div class="cta-faixa__img-wrap">
            <img src="assets/utima-secao.png" alt="Higienização profissional de estofados" loading="lazy">
          </div>

          <!-- Texto e botões lado direito -->
          <div class="cta-faixa__texto">
            <h2 class="cta-faixa__titulo" id="cta-titulo">
              Pronto para uma limpeza impecável?
            </h2>
            <p class="cta-faixa__sub">
              Agende agora ou fale connosco diretamente pelo WhatsApp. Rápido, simples e sem compromisso.
            </p>
            <div class="cta-faixa__acoes">
              <button class="btn btn-primario btn-lg" id="cta-final-btn">
